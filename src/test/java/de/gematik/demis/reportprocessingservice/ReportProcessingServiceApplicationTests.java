...
import de.gematik.demis.reportprocessingservice.processor.SecuredReportProcessingController;
...
class ReportProcessingServiceApplicationTests {
  ...
  @Autowired private SecuredReportProcessingController securedReportProcessingController;
  ...
  void controllerContextLoads() {
    assertThat(securedReportProcessingController).isNotNull();
  }
